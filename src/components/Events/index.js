...
class Events extends Component {
  state = {activeRegistrationStatus: ''}

  setActiveEventId = activeEventId => {
    const activeEvent = eventsList.find(
      eachItem => eachItem.id === activeEventId,
    )
    this.setState({activeRegistrationStatus: activeEvent.registrationStatus})
  }
    ...
    return (
      <div className="main-cont">
        ...
        <ActiveEventRegistrationDetails
          activeEventRegistrationStatus={activeRegistrationStatus}
        />
      </div>
    )
  }
